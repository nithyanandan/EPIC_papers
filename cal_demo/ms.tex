...
in the time dependence of the sky electric field. 
...
to form an estimate of the gains, $g'_a$, where the tick represents the estimate. For now we will assume we have formed an estimate 
...
The next step is to grid the calibrated electric field measurements. MOFF uses the antenna patterns as the gridding 
...
\begin{equation}
E'_j=\sum_a W_a(\mathbf{r}_i-\mathbf{r}_a) E'_a(t)
\end{equation}
This 
