...
cross-multiply the signals from all pairs of antennas, and 
...
after observing before further processing such as imaging. However, a direct imaging correlator mixes 
...
\end{equation}
Formally each pixel is calculated by summing over all antennas and their aperture illumination patterns.
...
box of 150~m. The antenna aperture illumination pattern used is a 4.4~m square tophat; a very rough 
...
drawn from an approximately gaussian distribution centered around 1 with width 0.25, and 
...
Fig.~\ref{fig:sim_images}. Each image is obtained over 400 time sample (10 ms) integration, corresponding to 
...
The results of our simulations are shown in Fig.~\ref{fig:errors}. The gain errors from our 
...
total of 1.536 seconds. The results of this calibration experiment are shown in Figs.~
...
left panel shows the uncalibrated image integrated over 51.2 ms, 83 kHz. Cyg~A is prominent 
...
were produced with 83 kHz bandwidth and 51.2 ms integration. The calibrated image shows 
...
absolute deviation of the image, a robust statistic. With this metric we find the uncalibrated 
and calibrated images to have dynamic ranges of 88.5 and 137, respectively, a 55\% 
improvement.
