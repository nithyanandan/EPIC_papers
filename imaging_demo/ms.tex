...
Calibration of direct imaging correlators remains a challenge. Contrary
...
traditional visibility-based imaging. In order to facilitate a robust comparison, 
these auto-correlations are removed from both the $uv$ and image planes, which 
is otherwise not an essential part of the core algorithm. We describe below how 
they can be removed from the $uv$ plane in a straightforward manner. 
