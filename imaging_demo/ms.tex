...
$\sim\Ngrid\log_2\Ngrid$, where $\Ngrid$ is the number of grid points in the 
...
timescales at GHz frequencies or slow transients from planetary and exoplanetary 
