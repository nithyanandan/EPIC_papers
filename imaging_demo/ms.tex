...
classes where the EPIC correlator is computationally more efficient and in the 
field of transients, demands significantly lesser I/O bandwidth relative to 
...
for each antenna, the computation complexity scales only as 
$\sim N_{\mathrm{a}}N_\textrm{c}$, where $N_\textrm{c}$ is the number of calibrators 
in the field. 
